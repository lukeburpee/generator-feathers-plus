...
function initSpecs (what, info) {
  ...
  switch (what) {
    ...
    case 'options':
      break;
    case 'banner':
      stashedSpecs.banner = stashedSpecs.banner || {};
      break;
    case 'app':
...
function updateSpecs (what, props, whosCalling) {
  ...
  let bannerSpecs, serviceSpecs, hookSpecs, connectionSpecs, graphqlSpecs, middlewaresSpecs, key2;
  ...
  switch (what) {
    ...
    case 'app':
      ...
      break;
    case 'banner':
      bannerSpecs = stashedSpecs.banner;
      bannerSpecs.title = props.title;
      bannerSpecs.titleColor = props.titleColor;
      bannerSpecs.subheader = props.subheader;
      bannerSpecs.subheaderText = props.subheaderText;
      bannerSpecs.subheaderColor = props.subheaderColor;
      break;
    case 'service':
